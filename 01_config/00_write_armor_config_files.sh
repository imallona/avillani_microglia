...
SRR4450428${TAB}SE${TAB}iPSC_MG_(Abud)${TAB}abud${TAB}WT
SRR4450429${TAB}SE${TAB}iPSC_MG_(Abud)${TAB}abud${TAB}WT
SRR4450430${TAB}SE${TAB}iPSC_MG_(Abud)${TAB}abud${TAB}WT
SRR4450431${TAB}SE${TAB}iPSC_MG_(Abud)${TAB}abud${TAB}WT
SRR4450432${TAB}SE${TAB}iPSC_MG_(Abud)${TAB}abud${TAB}WT
SRR4450433${TAB}SE${TAB}iPSC_MG_(Abud)${TAB}abud${TAB}WT
SRR4450434${TAB}SE${TAB}iHPC_(Abud)${TAB}abud${TAB}WT
SRR4450435${TAB}SE${TAB}iHPC_(Abud)${TAB}abud${TAB}WT
SRR4450436${TAB}SE${TAB}iHPC_(Abud)${TAB}abud${TAB}WT
SRR4450437${TAB}SE${TAB}iPSC_(Abud)${TAB}abud${TAB}WT
SRR4450438${TAB}SE${TAB}iPSC_(Abud)${TAB}abud${TAB}WT
SRR4450439${TAB}SE${TAB}iPSC_(Abud)${TAB}abud${TAB}WT
SRR4450440${TAB}SE${TAB}iPSC_(Abud)${TAB}abud${TAB}WT
SRR4450441${TAB}SE${TAB}CD14_M_(Abud)${TAB}abud${TAB}WT
SRR4450442${TAB}SE${TAB}CD14_M_(Abud)${TAB}abud${TAB}WT
SRR4450443${TAB}SE${TAB}CD14_M_(Abud)${TAB}abud${TAB}WT
SRR4450444${TAB}SE${TAB}CD14_M_(Abud)${TAB}abud${TAB}WT
SRR4450445${TAB}SE${TAB}CD14_M_(Abud)${TAB}abud${TAB}WT
SRR4450446${TAB}SE${TAB}CD16_M_(Abud)${TAB}abud${TAB}WT
SRR4450447${TAB}SE${TAB}CD16_M_(Abud)${TAB}abud${TAB}WT
SRR4450448${TAB}SE${TAB}CD16_M_(Abud)${TAB}abud${TAB}WT
SRR4450449${TAB}SE${TAB}CD16_M_(Abud)${TAB}abud${TAB}WT
SRR4450450${TAB}SE${TAB}Fetal_MG_(Abud)${TAB}abud${TAB}WT
SRR4450451${TAB}SE${TAB}Fetal_MG_(Abud)${TAB}abud${TAB}WT
SRR4450452${TAB}SE${TAB}Fetal_MG_(Abud)${TAB}abud${TAB}WT
SRR4450453${TAB}SE${TAB}Adult_MG_(Abud)${TAB}abud${TAB}WT
SRR4450454${TAB}SE${TAB}Adult_MG_(Abud)${TAB}abud${TAB}WT
SRR4450455${TAB}SE${TAB}Adult_MG_(Abud)${TAB}abud${TAB}WT
SRR4450456${TAB}SE${TAB}Blood_DC_(Abud)${TAB}abud${TAB}WT
SRR4450457${TAB}SE${TAB}Blood_DC_(Abud)${TAB}abud${TAB}WT
SRR12608405${TAB}SE${TAB}iPSC_MG_WT_(McQuade)${TAB}mccquade_trem2${TAB}WT
SRR12608406${TAB}SE${TAB}iPSC_MG_WT_(McQuade)${TAB}mccquade_trem2${TAB}WT
SRR12608407${TAB}SE${TAB}iPSC_MG_WT_(McQuade)${TAB}mccquade_trem2${TAB}WT
SRR12608408${TAB}SE${TAB}iPSC_MG_WT_(McQuade)${TAB}mccquade_trem2${TAB}WT
SRR12608409${TAB}SE${TAB}iPSC_MG_TREM2_KO_(McQuade)${TAB}mccquade_trem2${TAB}TREM2_KO
SRR12608410${TAB}SE${TAB}iPSC_MG_TREM2_KO_(McQuade)${TAB}mccquade_trem2${TAB}TREM2_KO
SRR12608411${TAB}SE${TAB}iPSC_MG_TREM2_KO_(McQuade)${TAB}mccquade_trem2${TAB}TREM2_KO
SRR12608412${TAB}SE${TAB}iPSC_MG_TREM2_KO_(McQuade)${TAB}mccquade_trem2${TAB}TREM2_KO
SRR7613924${TAB}iPSC_MG_2.0_(McQuade)${TAB}SE${TAB}mccquade_ipsc${TAB}WT
SRR7613925${TAB}SE${TAB}iPSC_MG_2.0_(McQuade)${TAB}mccquade_ipsc${TAB}WT
SRR7613926${TAB}SE${TAB}iPSC_MG_2.0_(McQuade)${TAB}mccquade_ipsc${TAB}WT
SRR8180288${TAB}SE${TAB}iHPC_2.0_(McQuade)${TAB}mccquade_ipsc${TAB}WT
SRR8180289${TAB}SE${TAB}iHPC_2.0_(McQuade)${TAB}mccquade_ipsc${TAB}WT
SRR8180290${TAB}SE${TAB}iHPC_2.0_(McQuade)${TAB}mccquade_ipsc${TAB}WT


caution ambra has technical replicates - wait


20220209.A_av111_WT_001_R1.fastq${TAB}SE${TAB}iPSC_MG${TAB}ambra${TAB}WT
20220209.A_av111_WT_002_R1.fastq${TAB}SE${TAB}iPSC_MG${TAB}ambra${TAB}WT
20220209.A_av111_WT_003_R1.fastq${TAB}SE${TAB}iPSC_MG${TAB}ambra${TAB}WT
20220209.A_tw029_WT_2_R1.fastq${TAB}SE${TAB}iPSC_MG${TAB}ambra${TAB}WT
20220209.A_tw029_WT_3_R1.fastq${TAB}SE${TAB}iPSC_MG${TAB}ambra${TAB}WT
20220504.B_WTC_1_R1.fastq${TAB}SE${TAB}iPSC_MG${TAB}ambra${TAB}WT
20220504.B_WTC_2_R1.fastq${TAB}SE${TAB}iPSC_MG${TAB}ambra${TAB}WT
20220504.B_SLC_EX2B1_1_R1.fastq${TAB}SE${TAB}iPSC_MG_Slc37a2_(mut1)${TAB}ambra${TAB}Slc37a2
20220504.B_SLC_EX2B1_2_R1.fastq${TAB}SE${TAB}iPSC_MG_Slc37a2_(mut1)${TAB}ambra${TAB}Slc37a2
20220504.B_SLC_EX6C5_1_R1.fastq${TAB}SE${TAB}iPSC_MG_Slc37a2_(mut2)${TAB}ambra${TAB}Slc37a2
20220504.B_SLC_EX6C5_2_R1.fastq${TAB}SE${TAB}iPSC_MG_Slc37a2_(mut2)${TAB}ambra${TAB}Slc37a2
20220504.B_TREM2_A1_1_R1.fastq${TAB}SE${TAB}iPSC_MG_TREM2_mut${TAB}ambra${TAB}WT${TAB}TREM2
20220504.B_TREM2_A1_2_R1.fastq${TAB}SE${TAB}iPSC_MG_TREM2_mut${TAB}ambra${TAB}WT${TAB}TREM2
EOF
...
design: "~ 0 + treatment"
contrast: iPSC_MG_Slc37a2_mutant-iPSC_MG,iPSC_MG_TREM2_mut-iPSC_MG,iPSC_MG_Slc37a2_mutant-iPSC_MG_TREM2_mut,iPSC_MG_Slc37a2_mutant-iPSC_MG_TREM2_KO_(McQuade),iPSC_MG_TREM2_mut-iPSC_MG_TREM2_KO_(McQuade),iPSC_MG-iPSC_MG_(Abud),
iPSC_MG-iHPC_(Abud),iPSC_MG-CD14_M_(Abud),iPSC_MG-CD14_M_(Abud),iPSC_MG-Fetal_MG_(Abud),iPSC_MG-Adult_MG_(Abud),iPSC_MG-Blood_DC_(Abud)
...
##---------------------------------------------------------------------------------------------
output: /home/imallona/avillani_microglia/armor_output/
##---------------------------------------------------------------------------------------------
