...
## Abud vs Villani's wildtypes and mutants {.tabset .tabset-pills}
...
## Abud vs Villani's wildtypes only  {.tabset .tabset-pills}
...
# All data combined {.tabset .tabset-pills}
...
if (is(camera_res, "data.frame")) {
    ...
    for (nm in names(camera_res)) {
        ...
        print(table(camera_res[[nm]]$FDR < 0.05))
...
# Villani's data, mutants vs 28-days-old WTs 
